...
public class Queries
{
    ...
    public static final String inertIntoColumnMappings = "INSERT INTO {iTracMediaDatabaseName}.columnmappings (sObject, tableName, sfField, selectedField, OrgId, SFUser, SFTimestamp) values(?,?,?,?,?,?,?)";
    ...
    public static final String inertIntoObjectMappings = "INSERT INTO {iTracMediaDatabaseName}.objectmappings (sObject, tableName, OrgId, SFUser, SFTimestamp) values(?,?,?,?,?)";
    public static final String inertIntoSyncSchedule = "INSERT INTO {iTracMediaDatabaseName}.syncschedule (OrgId, SFObject, SQLTable, SyncStartDate, SyncEndDate, IsEnabled, OccursAtEvery, SyncStartTime, SyncEndTime, OccuranceType, OccuranceValue, IsMonday, IsTuesdat, IsWednesday, IsThursday, IsFriday, IsSaturday, IsSunday, CreatedOn, SFUser, SFTimestamp) values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)";
